...
class MyApp extends PolymerElement {
  static get template() {
    return html`
      <style>
        ...
        app-toolbar.topo-menu {
          background-color: #c0392b;
          padding: 45px;
          height: auto;
        }

        app-toolbar.topo-menu img {
          width: 100%;
        }
      </style>
        ...
        <app-header-layout has-scrolling-region="">
          ...
          <app-header slot="header" condenses="" reveals="" effects="waterfall">
            <app-toolbar>
              ...
              <div main-title="">Lançamentos</div>
            </app-toolbar>
          </app-header>
  ...
  _routePageChanged(page) {
     ...
     // Show 'lancamentos' in that case. And if the page doesn't exist, show 'view404'.
    if (!page) {
      this.page = 'ultimos-lancamentos';
    } else if (['ultimos-lancamentos', 'view2', 'view3', 'new-view'].indexOf(page) !== -1) {
      this.page = page;
    } else {
      this.page = 'view404';
    }
